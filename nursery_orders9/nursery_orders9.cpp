...
Due Date: 07/27/2021			Total Points: 20
Assignment #: Assignment#9		Program Name: nursery_orders9.cpp
...
//Postcondition: Variables have been initialized. 
...
void order_class::process()
{
	for (int x = 0; x < count; ++x) {
		...
		//NOTE: ^ in order to match the sample output provided, the rate on the line above must be
		//.12, NOT .13. 
